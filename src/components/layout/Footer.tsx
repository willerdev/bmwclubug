    ...
    <footer className="relative border-t border-white/10 glass-frosted mt-8">
      ...
      <div className="section-padding container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex gap-3 mt-6">
              {[Globe, Share2, Mail].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 glass-panel rounded-full flex items-center justify-center text-white/50 hover:text-bmw-blue-light hover:border-bmw-blue/40 transition-colors">
                  <Icon size={18} />
                </a>
              ))}
            </div>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-sm uppercase tracking-wider text-bmw-blue-light">Quick Links</h3>
            <ul className="space-y-2">
              {NAV_LINKS.slice(0, 6).map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-white/50 hover:text-bmw-blue-light transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-semibold mb-4 text-sm uppercase tracking-wider text-bmw-red">Community</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-sm uppercase tracking-wider text-white/80">Contact</h3>
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm text-white/50">
                <MapPin size={16} className="text-bmw-red shrink-0" />
